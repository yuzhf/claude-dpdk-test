...
CFLAGS = -g -Wall -I${DIR_INC} -I${DIR_DPDK_INC} -I${DIR_EXT_INC}/cjson/include -I${DIR_EXT_INC}/libzmq/include -I${DIR_EXT_INC}/libhs/include -I${DIR_EXT_INC}/libjson/include -include rte_config.h -march=znver1 -DRTE_MACHINE_CPUFLAG_SSE -DRTE_MACHINE_CPUFLAG_SSE2 -DRTE_MACHINE_CPUFLAG_SSE3 -DRTE_MACHINE_CPUFLAG_SSSE3 -DRTE_MACHINE_CPUFLAG_SSE4_1 -DRTE_MACHINE_CPUFLAG_SSE4_2 -DRTE_MACHINE_CPUFLAG_AVX -DRTE_MACHINE_CPUFLAG_AVX2
